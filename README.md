...
```
This will take a bit of time to run. To manage your Conda environments, use the following commands to view envs installed, if it is successful, you will see an environent named EP-contacts:
```
conda info --envs
```
